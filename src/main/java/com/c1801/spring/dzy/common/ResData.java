...
public class ResData {
...

    {
        ...
        CODE_DESC.put(1006,"参数验证不通过");
        CODE_DESC.put(1007, "不应该是一个空集合");
        CODE_DESC.put(1008, "查询成功-但没有数据");
        CODE_DESC.put(2000,"业务处理失败，请重试");
        CODE_DESC.put(2002,"请登录");
    }
     ...
     * @return
     */
    public static ResData ofFail(Integer code,String desc, Object data){
        return of(code, desc, data);
    }
     ...
     * @return
     */
    public static ResData ofFail(Integer code, String desc) {

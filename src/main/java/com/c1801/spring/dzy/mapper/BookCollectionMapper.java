...
public interface BookCollectionMapper {
     ...
     * @return
     */
    public List<BookCollectionPack> getBookCollectionPack(@Param("start") Integer start,@Param("pageSize") Integer pageSize);
    ...
    public List<BookCollectionPack> getShowAllBookList();
...
//    public HashMap<String,Integer> getBookCollectionBookTotal(@Param("id")Integer id);
    ...
    public Integer queryBookCollectionApplaudTotal(@Param("id")Integer id);
    /**
     * 黄
     * 查询五个用户头像
     * @param id
...
//    public List<String> getBookCOllectionImage(@Param("id")Integer id);
     ...
     * @return
     */
    @Select("SELECT COUNT(id) FROM book_collection_tb WHERE state = 1 and expiration_date > now()")
...
//    public List<BookCollectionList> getBookCollectionBookByID(@Param("id")Integer id,@Param("page")Integer page);
     ...
     * @return
     */
    public Page<BookCollection> queryBookCollection();
